...
<jsp:useBean id="proizvodjaci" type="java.util.List" scope="request"></jsp:useBean>
...
<title>Uredi proizvodjaca</title>
</head>
...
<body>
		...
		<div id="body">
			<table id="listaProizvodjaca">
					...
					<tr>		
						<td></td>
						<td class="naslov">Naziv Proizvodjaca</td>
					</tr>
					<tr>
					<c:forEach items = "${proizvodjaci}" var = "proizvodjac">
						...
						<td ><a href="./ReadControllerModeli?proizvodjacId=${proizvodjac.prizvodjacID}">Prikazi model</a></td>
						</tr>
					</c:forEach>
				</table>
			<!-- listaVozila -->
